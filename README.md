...
I created a visualization dashboard website using visualizations we've created in a past assignment. Specifically, I plotted [weather data](Resources/cities.csv).
